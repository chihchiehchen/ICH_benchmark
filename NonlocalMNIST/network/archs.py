...
class SUTM(nn.Module):
    def __init__(self,out_ch = 1, in_ch=3, b_l =3,embed_dims=[  128,128,128],in_chans =[32,32,64,128]): # embed_dims=[ 128, 128,256, 512],in_chans =[32,64,96,128]  [ 128, 192, 256] # embed_dims=[ 128, 128,256, 256],in_chans =[32,32,64,128]
